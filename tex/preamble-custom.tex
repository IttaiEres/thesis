...
\renewcommand{\listtablename}{List of Tables
  \footnote{Note: Due to the large size of many of the tables, the tables
  have been provided in a supplementary file accompanying the
  dissertation. In such cases, the page number provided below directs the reader to a table’s title.
}}
% Try to add custom line for tables
\renewcommand{\protect\contentsline{List of Tables}{Supplemental Tables}{Online}}
% Nice tilde
